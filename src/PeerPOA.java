 ...
 implements PeerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getIdPeer", new java.lang.Integer (1));
    _methods.put ("actualizar_Lista_Peers", new java.lang.Integer (2));
    _methods.put ("updateCoordinator", new java.lang.Integer (3));
    _methods.put ("startElection", new java.lang.Integer (4));
    _methods.put ("sendOk", new java.lang.Integer (5));
    _methods.put ("iWon", new java.lang.Integer (6));
    _methods.put ("isalive", new java.lang.Integer (7));
    _methods.put ("getCoordinator", new java.lang.Integer (8));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // Peer/getIdPeer
       {
         String $result = null;
         $result = this.getIdPeer ();
         out = $rh.createReply();
       ...
       case 3:  // Peer/updateCoordinator
       {
         String coor = in.read_string ();
         this.updateCoordinator (coor);
         out = $rh.createReply();
         break;
       }

       case 4:  // Peer/startElection
       {
